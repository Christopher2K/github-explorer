...
class Operation implements OperationInterface
{
     ...
     *                       class name, or models.
     * - responseNotes:      (string) Information about the response returned by the operation
     * - responseType:       (string) One of 'primitive', 'class', 'models', or 'documentation'. If not specified, this
     *                       value will be automatically inferred based on whether or not there is a models matching the
    ...
    /**
     * Set what is returned from the method. Can be a primitive, class name, or models. For example: 'array',
     * 'Guzzle\\Foo\\Baz', or 'MyModelName' (to reference a models by ID).
     *
    ...
    /**
     * Set qualifying information about the responseClass. One of 'primitive', 'class', 'models', or 'documentation'
     *
