...
interface OperationInterface extends ToArrayInterface
{
    ...
    /**
     * Get what is returned from the method. Can be a primitive, class name, or models. For example, the responseClass
     * could be 'array', which would inherently use a responseType of 'primitive'. Using a class name would set a
     * responseType of 'class'. Specifying a models by ID will use a responseType of 'models'.
     *
     * @return string|null
     */
    ...
    /**
     * Get information about how the response is unmarshalled: One of 'primitive', 'class', 'models', or 'documentation'
     *
     * @return string
     */
