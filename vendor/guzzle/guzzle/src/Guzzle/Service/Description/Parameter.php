...
class Parameter
{
     ...
     *                  to include certain headers in a response models that have a normalized casing of FooBar, but the
     ...
     * - $ref:          (string) String referencing a service description models. The parameter is replaced by the
     *                  schema contained in the models.
     *
